"""
MicroPython driver specific for BBC Micro:bit :
...
class MAX44009:
    ...
    def __init__(self, i2c, address=MAX44009_I2C_DEFAULT_ADDRESS):
        ...
        self.set_configuration(MAX44009_REG_CONFIG_CONTMODE_DEFAULT | MAX44009_REG_CONFIG_MANUAL_OFF)

    def _set_reg(self, register, data):
        self.i2c.write(self.address, bytearray([register, data]))    

    def	_get_nbytes_reg(self, register, n=2):
        self.i2c.write(self.address, bytearray([register]))
        v =	self.i2c.read(self.address, n)
        return v
    ...
    def set_configuration(self, value):
        self._config = value
        self._set_reg(_MAX44009_REG_CONFIGURATION, self._config)

    def illuminance_lux(self):
        data = self._get_nbytes_reg(_MAX44009_REG_LUX_HIGH_BYTE)
